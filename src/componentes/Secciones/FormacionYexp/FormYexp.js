function FormyExp() {
    return (
        <section id="sec_formyexp" className='border shadow-def m-9 md:m-4 rounded-xl shadow-secondary-100 md:col-start-4 md:col-end-8 md:row-start-2 md:row-end-3 '>

            <h1 className='text-2xl text-secondary-200 font-bold m-4 mt-8 text-center md:text-3xl '>Formacion Academica</h1>
            ...
            {/* Experiencia*/}
            <h1 className='text-2xl text-secondary-200 font-bold m-4 text-center md:text-3xl '>Experiencia</h1>
            <ol className="relative ml-8  border-s mb-10  border-gray-700 ">
                <li className="mb-10 ms-6 mx-4">
                    ...
                    <h3 className="font-medium italic leading-tight text-secondary-150 mb-2">Practicante HelpDesk L2 - Accenture</h3>
                    <p className="text-sm">Soporte tecnico en remoto a usuarios en dominio de sanidad</p>
                </li>
                <li className="ms-6 mx-4">
                    <span className="absolute flex items-center justify-center w-8 h-8 rounded-full -start-4 ring-4  ring-secondary-700 bg-secondary-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="work"><path fill="none" d="M0 0h24v24H0V0z"></path><path fill="white" d="M14 6V4h-4v2h4zM4 9v9c0 .55.45 1 1 1h14c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1H5c-.55 0-1 .45-1 1zm16-3c1.11 0 2 .89 2 2v11c0 1.11-.89 2-2 2H4c-1.11 0-2-.89-2-2l.01-11c0-1.11.88-2 1.99-2h4V4c0-1.11.89-2 2-2h4c1.11 0 2 .89 2 2v2h4z"></path></svg>
                    </span>
                    <h3 className="font-medium italic leading-tight text-secondary-150 mb-2">Practicante Desarrollador Web Fullstack - Sstrategy Fintech  </h3>
