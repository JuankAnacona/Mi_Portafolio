...
function Proyectos() {
    return (
        <section id="sec_proyectos" className='relative overflow-hidden border border-secondary-300/20 bg-gradient-to-b from-primary/80 to-secondary-700/40 backdrop-blur-xl shadow-[0_0_40px_rgba(122,80,255,0.1)] m-0 rounded-2xl'>
