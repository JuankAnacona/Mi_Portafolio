        ...
        <div className="mx-4 my-4 flex flex-col md:flex-row items-center bg-gradient-to-br from-secondary-700/80 to-primary border rounded-xl shadow-lg lg:max-w-4xl border-secondary-300/20 hover:border-secondary-300/50 hover:shadow-[0_0_30px_rgba(122,80,255,0.2)] transition-all duration-300 group overflow-hidden">
            ...
            <div className="w-full flex flex-col p-4">
                <div className="flex justify-between items-start mb-2">
                    <h5 className="text-xl font-bold tracking-tight text-white group-hover:text-secondary-150 transition-colors">{t.proyectos.agapea.title}</h5>
                ...
                <p className="mb-4 text-sm font-normal text-gray-300 leading-relaxed max-w-2xl">
                    {t.proyectos.agapea.desc}
                </p>

                <div className="flex flex-wrap items-center justify-between gap-4 mt-auto pt-3 border-t border-secondary-300/10">
                    <div className="flex gap-2">
                        <span className="bg-secondary-300/10 text-secondary-100 px-2.5 py-1 rounded-md text-[10px] font-bold border border-secondary-300/10 uppercase tracking-wider">{t.proyectos.agapea.tag1}</span>
                        <span className="bg-secondary-300/10 text-secondary-100 px-2.5 py-1 rounded-md text-[10px] font-bold border border-secondary-300/10 uppercase tracking-wider">{t.proyectos.agapea.tag2}</span>
                    </div>
