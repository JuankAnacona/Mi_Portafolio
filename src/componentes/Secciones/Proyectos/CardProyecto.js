    ...
    return (
        <div className=" mx-4 my-6 flex flex-col items-center border  rounded-lg shadow  md:flex-row md:max-w-2xl border-gray-700 bg-secondary-700 hover:bg-secondary-650">
            ...
            <div>
                ...
                <button className='mx-4 my-3 bg-secondary-300 text-sm rounded-2xl p-2 px-2 hover:scale-110 hover:bg-secondary-250 transition ease-in-out  duration-300' disabled>
                    <span className='flex'>Repositorio Privado&nbsp;
                ...
                <button className='mx-4 my-3 bg-secondary-300 text-sm rounded-2xl p-2 px-2 hover:scale-110 hover:bg-secondary-250 transition ease-in-out  duration-300'>
                    <a className='flex' href={`${process.env.PUBLIC_URL}/PAGINAWEB–SAYDAMAYA.pdf`} download="PAGINAWEB–SAYDAMAYA.pdf" >Documentacion&nbsp;
                ...
                <button className='mx-4 my-3 bg-secondary-300 text-sm rounded-2xl p-2 px-2 hover:scale-110 hover:bg-secondary-250 transition ease-in-out  duration-300'>
                    <a className='flex' href="https://clinica-odontolgica.vercel.app/Clinica/Inicio" target="_blank" rel="noreferrer" >Ir a Web&nbsp;
