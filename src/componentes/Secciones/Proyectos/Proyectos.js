...
function Proyectos() {
    return (
        <section id="sec_proyectos" className='relative overflow-hidden border border-secondary-300/20 bg-gradient-to-b from-primary/80 to-secondary-700/40 backdrop-blur-xl shadow-[0_0_40px_rgba(122,80,255,0.1)] m-9 md:m-4 rounded-2xl md:col-start-4 md:col-span-4 md:row-start-1 md:row-end-2'>
